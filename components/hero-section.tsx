...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Desktop: Full hero with overlay and content */}
      <div className="hidden md:flex relative min-h-[85vh] items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl">
            ...
            >
              <span className="inline-block px-4 py-1.5 bg-primary text-primary-foreground text-sm font-bold rounded-full">
                Ontario Made
              </span>
              <span className="inline-block px-4 py-1.5 bg-white/20 text-white text-sm font-semibold rounded-full backdrop-blur-sm">
                Premium Quality
              </span>
            </div>
            <h1 
              className={`font-serif text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight text-balance
